...
def prep_chunk(chunks_remaining, manifest, chunk_num):
...
if __name__ == "__main__":
    ...
    while chunk:
        ...
        Bdelay, chosen_bitrate = simulator_comm.send_req_json(previous_bitrate,previous_list,prev_throughput,av_bitrates,chunk_arg)
        previous_bitrate=chosen_bitrate
